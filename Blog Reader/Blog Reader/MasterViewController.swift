...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url  = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyBtnz7aSRPjL1fLDNxJ5eDtzRx7aMMWyq0")!
                ...
                if let urlContent = data {
                    ...
                    do {
                        ...
                        if let items = jsonResult["items"] as? [[String:Any]] {
                            ...
                            let request = NSFetchRequest<Event>(entityName: "Events")
